<?php require "includes/header.php"; ?>
    ...
    <div class="card-body">
        ...
        <h2 class="text-center">STUDENTS OF CLASS <strong>SIX</strong></h2>
        <hr>

        <?php
        if (isset($_POST['key']) && ($_POST['key'] != "")) {
            $students = $student->getStudentBySearch($_POST['key'], 'class_six_students');
        } else {
            $students = $student->getStudents('class_six_students');
        }
        ?>
