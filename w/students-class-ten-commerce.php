<?php require "includes/header.php"; ?>
    ...
    <div class="card-body">
        ...
        <h2 class="text-center">STUDENTS OF CLASS <strong>TEN</strong> (COMMERCE)</h2>
        <hr>

        <?php
        if (isset($_POST['key']) && ($_POST['key'] != "")) {
            $students = $student->getClassTenGroupStudentsBySearch($_POST['key'], 'Commerce', 'class_ten_students');
        } else {
            $students = $student->getClassTenStudentsByGroup('class_ten_students', 'Commerce');
        }
        ?>
