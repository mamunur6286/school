                ...
                <div class="col-md-4">
                    <div class="card  mt-5 login-panel">
                        <div class="card-body bg-transparent">
                            ...
                            <p style="margin-top: -10px;font-size: 18px" class="text-center font-italic">Forget Password</p>
                            <div class="card-body" style="margin-top: -15px">

                                <?php
                                if($_SERVER['REQUEST_METHOD']== 'POST' && isset($_POST['send_btn'])){
                                    $forgetPassword=$login->forgetPassword($_POST);
                                    if ($forgetPassword){
                                        echo $forgetPassword;
                                    }
                                }
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        <input style="font-size: 16px" name="send_btn"  type="submit" class="btn btn-primary btn-block float-right" value="Send Password">
                                    </div>
                                </form>
                            </div>
                        </div>
                        <p class="text-center text-info font-italic" style="margin-top: -10px"><a  style="text-decoration: none;" href="login.php">Back To Login</a></p><br>
                    </div>
                </div>
                <div class="col-md-4"></div>
            </div>
