...
<section class="content-header">
    <h1> Dashboard <small>Admission Student</small></h1>
    <ol class="breadcrumb">
            ...
            <div class="">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-3">
                        <a href="update_admission.php?stu_id=<?php echo $_GET['stu_id']; ?>" type="submit" class="btn btn-info btn-block">Update Profile</a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-3"></div>
                </div>
            </div>
