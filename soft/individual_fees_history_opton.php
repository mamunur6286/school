...
?>
    ...
    <section class="content-header">
        <h1> Dashboard <small>Fees Management</small></h1>
        <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        ...
                        <?php
                            if($_SERVER['REQUEST_METHOD']== 'POST' && isset($_POST['btn_submit'])){
                                $select_option=$fees->selectStudentForIndividualFees($_POST);
                            }
                        ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="roll" type="text" class="form-control"  placeholder="Enter student roll">
                                            </div>
                                            <div class="form-group">
