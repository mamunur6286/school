                    ...
                    <div class="col-md-12">
                        <div class="card   mt-5 login-panel">
                            <div class="card-body bg-transparent">
                                ...
                                <h6 class="text-center font-italic login">Login</h6>
                                <?php

                                if ($_SERVER['REQUEST_METHOD']=='POST' && $_POST['login_btn']){
                                    $msg=$teacherLogin->login($_POST);
                                }
                                if (isset($msg)){
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        <input style="font-size: 13px" type="password" name="password" class="form-control font-italic" placeholder="Your Password">
                                    </div>
                                    <div class="form-group">
                                        <input style="font-size: 13px"  type="submit" name="login_btn" class="btn btn-primary btn-block float-right" value="Login">
                                    </div>
                                </form>
                                <?php
                            ...
                            <p class="text-center text-info font-italic"><a  style="text-decoration: none; font-size: 14px" href="forget_password.php">Forget Password?</a></p>
                        </div>
                    </div>
                </div>
